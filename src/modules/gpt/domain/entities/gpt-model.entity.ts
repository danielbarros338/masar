...
export class GptModelEntity {
  ...
  get isDeprecated(): boolean { return this.props.isDeprecated; }
  get supportsChats(): boolean { return this.props.supportsChats; }
  get supportsStreaming(): boolean { return this.props.supportsStreaming; }
  get supportsReasoning(): boolean { return this.props.supportsReasoning; }
  ...
  get speedScore(): number { return this.props.speedScore; }
